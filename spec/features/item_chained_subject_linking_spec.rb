...
RSpec.describe 'Item has functioning chained subject linking', type: :feature do
  scenario 'User can view and use subject chain' do
    VCR.use_cassette('item_chained_subject_linking') do
      ...
      within(first('ul.subject-chain-links li')) do
      ...
      visit '/catalog/1002481'
      within(first('ul.subject-chain-links li')) do
        click_on 'Stage history'
      end
      expect(page).to have_css('.appliedFilter', text: 'Shakespeare, William, 1564-1616 Stage history')
      expect(page).to have_text('Shakespeare at the Globe : 1599-1609')
      ...
      expect(page).to have_css('.appliedFilter', text: 'Shakespeare, William, 1564-1616 Stage history To 1625')
      expect(page).to have_text('Shakespeare at the Globe : 1599-1609')
    end
  end
end
