...
class ProfilesController < ApplicationController
  ...
  http_basic_authenticate_with name: Rails.application.secrets.profiles_edit_user, password: Rails.application.secrets.profiles_edit_password, except: %i[index show]
